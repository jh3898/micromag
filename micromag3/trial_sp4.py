...
from micro_jinting2.common.sim import Sim
from micro_jinting2.micro.CuboidMesh import CuboidMesh
from micro_jinting2.micro.exchange import UniformExchange
#from micro_jinting2.micro.demag import Demag
from micro_jinting2.micro.Zeeman import Zeeman
from common.fileio import DataReader

mu0 = 4 * np.pi * 1e-7
#from CuboidMesh import CuboidMesh
...
def deal_plot():
    ...
    plt.plot(ts, mx, '--', label='m_Jinting', dashes=(2, 2))
